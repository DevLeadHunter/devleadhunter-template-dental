/** Static content mirrored 1:1 from the Pencil Family Dental Care mockup. */

export const site = {
  name: 'Family Dental Care',
  tagline: 'Dentistry and Orthodontics',
  phone: '123 456 7890',
  phoneFormatted: '(12) 345-67890',
  email: 'contact@example.com',
  address: 'Cooks Mill Rd, Halifax NS, Canada',
  addressShort: 'Cooks mill road halifax',
  hours: 'Office Hour: 08:00am - 6:00pm',
  copyright: '© 2024 Family Dental Care. All rights reserved.',
}

export const hero = {
  eyebrow: 'HALIFAX FAMILY DENTAL CARE',
  heading: 'Local dentists who love to make you smile.',
  subheading: 'Discover a level of dental care like no other',
  ctaPrimary: 'Book an Appointment',
  ctaSecondary: 'Browse our service',
  image: '/images/image-import-7.png',
...
export const featured = {
  eyebrow: 'WELCOME TO HALIFAX FAMILY DENTAL CARE',
  heading: 'Creating beautiful smiles for all ages',
  body: 'We are a family dental practice that has earned the trust of our patients through honesty, efficiency, and good communication.',
  line: '/exports/W25rs.png',
  images: [
    { src: '/images/image-import-1.jpg', offset: 'low' },
    { src: '/images/image-import-19.jpg', offset: 'high' },
    { src: '/images/image-import-1.png', offset: 'mid' },
    { src: '/images/image-import-9.jpg', offset: 'high' },
  ],
  stats: [
...
export const services = {
  ...
  heading: 'Quality dental services',
  body: 'Our dentists provide a range of services to all ages and needs to keep their teeth and gums healthy for life',
  cards: [
    {
